...
session_data = {
    ...
    "results_file": 'strategy_2_new_llama-3-sauerkrautlm-70b-instruct.csv',
    "history_length": 6,
    "previous_close": None,
        ...
        try:
            response = requests.post(
                ...
                headers={
                    ...
                    "Cookie": "mod_auth_openidc_session=89a7c134-7a8d-42cb-a87b-ca4760d0f769",
            ...
            print(e)
            input("Error occurred. Press Enter to retry.")
